...
RUN sudo git clone https://github.com/NewEagleRaptor/raptor-dbw-ros.git /opt/pacifica-dbw-ros --branch master --depth 1 && sudo cp /opt/pacifica-dbw-ros/raptor_dbw_can/New_Eagle_DBW_3.3.388.dbc /opt/carma/install/share/raptor_dbw_can/New_Eagle_DBW_3.3.388.dbc && sudo rm -rf /opt/pacifica-dbw-ros
