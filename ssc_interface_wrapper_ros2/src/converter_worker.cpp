...
namespace ssc_interface_wrapper{
    ...
    carma_ros2_utils::CallbackReturn Converter::handle_on_configure(const rclcpp_lifecycle::State &)
   {
       // Load parameters
        ...
        // This was being done in autoware.ai using message_filters:
        // https://github.com/usdot-fhwa-stol/autoware.ai/blob/1cb4e74b810111369a6bbe49b0e64e07767454c0/drivers/as/nodes/ssc_interface/ssc_interface.h#L58
        // However, message_filters currently doesn't support LifecycleNode.
        // The implementation here should be updated to keep the output relatively synchronized in the future
